...
export default {
  ...
  companyStats: [
    { label: 'godina isporuke softvera' },
    { value: '80+', label: 'dizajna web stranica u našem izlogu' },
    { value: 'Od A do Ž', label: 'web, e-trgovina, mobilne app i AI' },
  ],
  ...
  techGroups: {
    frontend: 'Frontend',
    backend: 'Backend',
    mobile: 'Mobilne tehnologije',
    'cloud-devops': 'Cloud i DevOps',
    data: 'Podaci',
    'commerce-cms': 'E-trgovina i CMS',
    also: 'Također u našem alatu',
  },
  ...
  home: {
    ...
    team: {
      eyebrow: 'Tim',
      headingHtml: 'Mali <em class="text-accent">tim</em> - veliko <em class="text-accent">iskustvo</em>',
      meetAll: 'Upoznajte cijeli tim →',
    },
    cta: { h2: 'Imate projekt na umu?', p: 'Recite nam što gradite. Mi ćemo vam reći kako bismo to isporučili.' },
  },
  ...
  team: {
    ...
    viewProfileAria: 'pogledaj profil',
    viewProfileAria2: 'Pogledaj cijeli profil:',
  },
  ...
  skills: { eyebrow: 'Vještine', heading: 'Vještine i alati' },
  ...
  contact: {
    ...
    projectTypes: {
      ...
      ai: 'AI automatizacija',
      other: 'Nešto drugo',
    },
    helpLabel: 'S čime vam možemo pomoći?',
    nameLabel: 'Ime',
    emailLabel: 'Email',
